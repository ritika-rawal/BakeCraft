...
const styles = {
  nav: { background: '#fff', borderBottom: '1px solid rgba(0,0,0,0.05)', padding: '16px 0' },
  ...
  search: { border: '1px solid #eee', borderRadius: '20px', padding: '8px 16px', fontSize: '13px', width: '160px' },
  icon: { fontSize: '18px', color: 'var(--text-muted)', cursor: 'pointer' },
  loginLink: { fontSize: '14px', color: 'var(--text-muted)', cursor: 'pointer' },
